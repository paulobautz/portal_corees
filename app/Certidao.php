...
class Certidao extends Model
{
    ...
    public static function declaracaoRegularidade($dadosRepresentante, $numero, $codigo, $data, $hora, $dataValidade) 
    {
        ...
        // Rodapé da certidão
        $declaracao .=  '<p class="texto-certidao">Esta certidão possui o número <b>' . $numero . '</b>, emitida em <b>' . $data . ', </b>às<b> ' . $hora . '</b> e é válida até <b>' . $dataValidade . '</b>. Para verificar a autenticidade deste documento entre no site do Core-ES https://www.core-es.org.br/certidao/consulta e utilize o código abaixo ou leia o QR Code:<p>';
