      ...
      <div class="col-lg-8 consulta-linha">
        ...
        <div class="row nomargin mt-4">
          <div class="alert alert-warning consulta-alert" role="alert">
            ...
            <p>Caso seja constatada qualquer divergência de dados, solicitamos a gentileza de entrar em contato conosco através do email registro@core-es.org.br ou pelo telefone (27) 3223-3502.</p>
          </div>
        </div>
      </div>
      <div class="col-lg-4">
