    ...
    <div class="container">
        ...
        <div class="row mt-2">
            <div class="col-lg-8 conteudo-txt pr-4">
                ...
                <p>Ou, se preferir, acesse a <a href="/representante/login">Área Restrita do Representante,</a> e confira também outras informações relativas ao seu cadastro junto ao Core-ES, incluindo seu extrato financeiro detalhado.</p>
                ...
                @if(Session::get('nossonumero'))
                    ...
                    <h3 class="text-uppercase">
                        <a href="https://boletoonline.caixa.gov.br/ecobranca/SIGCB/imprimir/591478/{{ Session::get('nossonumero')[0]['NOSSONUMERO'] }}" class="normal text-info">
