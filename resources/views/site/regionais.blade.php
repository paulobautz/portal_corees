...
@section('description')
  <meta name="description" content="O Core-ES possui escritórios seccionais espalhados por regiões estratégicas em todo o estado do Espirito Santo. Encontre o escritório mais próximo de você.">
@endsection
