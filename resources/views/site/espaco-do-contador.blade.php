...
<section id="pagina-noticias">
  <div class="container">
    ...
    <div class="conteudo-txt text-justify">
      ...
      <p class="pb-0">Além de registrar, orientar, normatizar e fiscalizar o exercício da profissão, o Conselho Regional dos Representantes Comerciais no Estado do Espirito Santo também busca preservar os interesses públicos de toda a sociedade.</p></br>
      ...
      <p class="pb-0">A nova ferramenta é o resultado de um Termo de Cooperação, firmado em setembro de 2020, entre o Core-ES e o Conselho Regional de Contabilidade deste Estado (CRC-SP) - que busca facilitar a rotina de contadores, representantes e até mesmo das empresas representadas. Assim, a realização de procedimentos administrativos se tornará mais prática e ágil,  possibilitando a rápida efetivação de novos negócios.</p></br>
    </div>
